  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col bg-white overflow-hidden" style={arialFont}>
      ...
      <div className="relative w-full flex-grow overflow-hidden">
        <div 
          className="absolute inset-0 bg-cover bg-no-repeat bg-[55%_center] lg:bg-center md:bg-fixed"
      ...
      <div className="relative w-full z-20">
        ...
        <div className="absolute bottom-[-1px] left-0 w-full overflow-hidden leading-[0]">
          <svg 
            ...
            className="relative block w-full h-[60px] md:h-[120px] scale-x-110 scale-y-125 origin-bottom"
          >
            <path 
      ...
      <div 
        ...
        /* mt-[-1px] adds one more layer of protection against lines */
        className="relative z-10 w-full pb-8 md:pb-12 mt-auto mt-[-1px]"
      >
        <div className="max-w-7xl mx-auto px-6 w-full text-center">
          <div className="flex flex-col items-center justify-center gap-1.5 md:gap-2">
            ...
            <div className="flex items-center justify-center gap-3 whitespace-nowrap">
              <HeartPulse className="text-white w-6 h-6 md:w-9 md:h-9 animate-pulse flex-shrink-0" strokeWidth={2} />
